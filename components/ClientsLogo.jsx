...
<div class="flex flex-col sm:flex-row sm:items-center sm:justify-between leading-none">
            ...
            {/* <div  ref={ref} className={`font-raleway  uppercase sm:text-[35px] text-[27px] !font-bold    transition-transform duration-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 sm:translate-y-32 -translate-y-10'}`}> */}
            <span  ref={ref} className="font-raleway  uppercase sm:text-[35px] text-[27px] !font-bold ">
